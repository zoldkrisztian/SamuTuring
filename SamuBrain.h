...
class Habituation
{
    ...
    constexpr static int ma_limit {1};
...
class SamuBrain
{
    ...
    MORGAN newMPU ();
            int pred ( int **reality, int *, int, int **predictions, int, int &, int &, int & );
    int pred ( MORGAN, int **reality, int *, int, int **predictions, int, int &, int &, int & );
